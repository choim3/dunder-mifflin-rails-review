...
Dog.create(name: "Lucky", breed: "Perfecto", age: 7)
Dog.create(name: "Soju", breed: "Shiba", age: 1)
Dog.create(name: "Maru", breed: "Maltese", age: 8)
Dog.create(name: "Elle", breed: "Shizhu", age: 13)
Dog.create(name: "Anju", breed: "Tabby", age: 1)
